...
public class OrderController {
    ...
    /**
     * Người dùng chọn 1 hoặc nhiều item từ giỏ hàng, thanh toán qua VNPAY.
     * Tạm thời truyền customerId trên path, sau này có JWT thì lấy từ token.
     */
    @PostMapping("/checkout-vnpay/{customerId}")
    public ResponseEntity<CheckoutResponse> checkoutWithVnPay(
